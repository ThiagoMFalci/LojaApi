...
O projeto segue uma organização em camadas, facilitando a manutenção e escalabilidade:
...
Este projeto tem como finalidade o aprendizado prático de desenvolvimento de APIs com C#, incluindo conceitos como:
- REST
- CRUD
